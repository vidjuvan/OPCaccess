...
#define IOPCAsyncIO2_Refresh(This,dwSource,dwTransactionID,pdwCancelID)	\
    (This)->lpVtbl -> Refresh(This,dwSource,dwTransactionID,pdwCancelID)
...
HRESULT STDMETHODCALLTYPE IOPCAsyncIO2_Refresh_Proxy( 
    IOPCAsyncIO2 __RPC_FAR * This,
    /* [in] */ OPCDATASOURCE dwSource,
    /* [in] */ DWORD dwTransactionID,
    /* [out] */ DWORD __RPC_FAR *pdwCancelID);
...
void __RPC_STUB IOPCAsyncIO2_Refresh_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
